        ...
        <div className="space-y-10" style={{ borderTop: '1px solid #e8e3dc', paddingTop: '3rem' }}>
          ...
          <section>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="mb-2" style={{ fontSize: '1rem', fontWeight: 600, color: '#1a1a1a' }}>Data encryption</h3>
              ...
              <div>
                <h3 className="mb-2" style={{ fontSize: '1rem', fontWeight: 600, color: '#1a1a1a' }}>Access controls &amp; multi-tenant isolation</h3>
                <p className="leading-relaxed" style={{ color: '#4a4a5a', maxWidth: '60ch', fontSize: '0.9rem' }}>
              ...
              <div>
                <h3 className="mb-2" style={{ fontSize: '1rem', fontWeight: 600, color: '#1a1a1a' }}>Authentication</h3>
                <p className="leading-relaxed" style={{ color: '#4a4a5a', maxWidth: '60ch', fontSize: '0.9rem' }}>
              ...
              <div>
                <h3 className="mb-2" style={{ fontSize: '1rem', fontWeight: 600, color: '#1a1a1a' }}>Security headers</h3>
              ...
              <div>
                <h3 className="mb-2" style={{ fontSize: '1rem', fontWeight: 600, color: '#1a1a1a' }}>Code review &amp; dependency scanning</h3>
                <p className="leading-relaxed" style={{ color: '#4a4a5a', maxWidth: '60ch', fontSize: '0.9rem' }}>
          ...
          <section>
            ...
            <p className="mb-6 leading-relaxed" style={{ color: '#4a4a5a', maxWidth: '60ch' }}>
              Sentra is built on a carefully selected set of infrastructure providers. We describe them by category here. A complete list with names, locations, and data transfer frameworks (DPF/SCCs) is available in our Data Processing Addendum (DPA) — contact{' '}
              <a
              ...
              {[
                {
                  ...
                  description: 'Leading cloud provider with EU region capability and global edge delivery network.',
                },
                {
                  category: 'Database & Authentication',
                  description: 'Managed Postgres provider with EU region. Handles data storage and user authentication.',
                },
                {
                  category: 'Payment processing',
                  description: 'PCI-DSS Level 1 certified payment processor. Covered by the EU-US Data Privacy Framework (DPF) and Standard Contractual Clauses (SCCs).',
                },
                {
                  category: 'AI processing',
                  description: 'Enterprise-grade LLM provider covered by DPF + SCCs. Does not train on customer data. See Privacy Policy for full details.',
                },
                {
                  category: 'Email infrastructure',
                  description: 'DPF-certified providers for transactional email (notifications, billing) and outbound email delivery (campaigns).',
                },
                {
                  category: 'Product analytics',
                  description: 'EU-resident analytics platform. All data stays in the EU (Frankfurt). No advertising profiles, no data transfers outside EU.',
                },
          ...
          <section>
            ...
            <ul className="mt-4 space-y-3" style={{ color: '#4a4a5a', maxWidth: '60ch' }}>
              ...
              <li className="flex gap-3">
                <span style={{ color: '#3b6bef', fontWeight: 600, flexShrink: 0 }}>—</span>
                <span className="leading-relaxed">A post-mortem describing the incident, its scope, and remediation steps will be published at{' '}
                  <code style={{ fontSize: '0.85em', backgroundColor: '#f0ede8', padding: '1px 5px', borderRadius: '3px' }}>status.sentra.app</code>
                  {' '}(coming soon) for material incidents.
                </span>
              </li>
            </ul>
            <p className="mt-4 leading-relaxed" style={{ color: '#4a4a5a', maxWidth: '60ch' }}>
              ...
              <a
                href="mailto:security@sentra.app"
                className="transition-opacity hover:opacity-70"
                style={{ color: '#1a1a1a', textDecoration: 'underline', textUnderlineOffset: '3px' }}
              >
                security@sentra.app
