                  ...
                  {legalLinks.map(({ href, label }) => {
                    ...
                    return (
                      <li key={href}>
                        <Link
                          href={href as never}
                          className="block py-1.5 text-sm transition-colors rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563eb] focus-visible:ring-offset-2"
                          style={{
